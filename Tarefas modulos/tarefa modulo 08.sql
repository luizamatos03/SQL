/* Além da sintaxe INNER JOIN, estudamos diversas outras opções de relacionamentos entre tabelas SQL, que a
partir de agora te permitem explorar as mais diversas bases de dados. Não haverá um dia no seu trabalho com
...
1. A gestão da locadora decidiu que no mês de julho de 2005 haverá um prêmio para o funcionário que mais
registrou vendas, e pediu sua ajuda para determinar a premiação.
...
/* 2. Na tarefa do módulo anterior, você descobriu que alguns aluguéis ainda não foram devolvidos. Precisamos
buscar esses itens! Escreva uma consulta que retorne a lista de emails das pessoas que estão com aluguéis
pendentes, e o número de itens a serem retornados.
Bônus opcional: utilize a função GROUP_CONCAT, que estudamos no módulo 5, para retornar também uma lista
com o nome dos filmes que devem ser devolvidos. */
